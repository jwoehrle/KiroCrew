...
export default function ChatPane({
  ...
  // Orchestrator plan dispatch (#5893) — same mutation ChatPage uses, targeting
  // THIS pane's slot. Read through a ref for the same reason as the picked set:
  // the handler must see the in-flight state, not the render it closed over.
